...
- **🌈 HDR Support**: BT.2020/PQ/HLG metadata extraction (demuxer) + Display-P3 rendering (player)
- **📦 Universal Format Support**: MP4, MKV, WebM, MOV, MPEG-TS, and more via FFmpeg
- **🎬 Professional UI**: Built-in controls with gestures, themes, and multi-track selection
